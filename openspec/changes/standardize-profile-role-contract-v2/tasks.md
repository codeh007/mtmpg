...
- [ ] 1.2 提交并推送完整规划工件到`main`，记录精确source SHA

## 2. 测试先行RED

- [ ] 2.1 更新Rust JWT、profile-role、identity与ABI领域测试及共享OAuth fixture，使其要求三个v2下划线名称和`pggomtm:v2`
- [ ] 2.2 更新真实PG18与final-image最小行为测试，覆盖v2同名startup role并拒绝v1、项目前缀和阶段前缀名称
